...
namespace Services.Common
{
    public static class CommonExtensions
    {
        public static WebApplicationBuilder AddServiceDefaults(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<IUserAccessor, UserAccessor.UserAccessor>();
        ...
        public static WebApplication UseServiceDefaults(this WebApplication app)
        {
            ...
            app.UseCors(x => { x.AllowAnyOrigin(); x.AllowAnyHeader(); x.AllowAnyMethod(); x.SetIsOriginAllowed(x => true);x.WithOrigins("http://localhost:5173", "http://*:5173", "http://*:*", "http://localhost:*", "http://hackaton.codarecord.ru"); });
